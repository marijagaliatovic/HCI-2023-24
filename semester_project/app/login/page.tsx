  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-col items-center relative lg:mt-12 py-8 w-full lg:max-content flex-grow">
          ...
          <form onSubmit={handleSubmit} className="bg-white mb-20 pb-10 mx-5 sm:mx-auto md:mx-auto max-w-md px-12 rounded-md shadow-lg w-1/2 sm:w-2/3 w-4/5">
                  ...
                  <p className="bg-white mt-5 text-center py-5 text-sm text-gray-400">

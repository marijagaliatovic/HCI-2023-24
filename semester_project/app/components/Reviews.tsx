...
const Reviews = async () => {
  ...
  return (
      <div className="bg-gray-400 flex flex-col items-center relative lg:mt-12 py-8">
          ...
          <i className="bg-stone-200 lg:mr-16 text-center not-italic text-sm lg:text-md font-bold hover:bg-slate-600 rounded-md p-2 shadow-xl tracking-wide"><Link href="/reviews" className="bg-transparent">View all</Link></i>
          </div>

...
export default function Filter({setData,data}:FilterProps){
    ...
    return(
        <>
            <div id="filters" className="bg-white relative w-max  flex flex-row px-4 m-1 rounded-md lg:rounded-full justify-center gap-1 lg:items-center hover:bg-slate-500 cursor-pointer shadow-lg" onClick={handleFiltersClick}>
            ...
            {(isFiltersOpen && (
                <>
                    ...
                    {/*Filters Dropdown */}
                    <div  id="filterDropdown" className="bg-slate-400 absolute z-50 top-0 flex flex-col lg:w-max w-7/8 h-max lg:h-max shadow-lg p-4 rounded-md m-5">

  ...
  return (
    <div className="bg-stone-200 flex flex-col items-center justify-center relative lg:mt-12 py-8">
      ...
      <div className="bg-transparent mt-4 w-full lg:ml-12 lg:w-2/3  flex justify-center lg:justify-end">
          <i className="bg-gray-400  text-center not-italic text-sm lg:text-md font-bold hover:bg-slate-600 rounded-md  p-2 shadow-xl tracking-wide  "><Link href="/specialoffers" className="bg-transparent">View all</Link></i>
      </div>
    </div>
  );
}

        ...
        <div className="flex flex-row flex-wrap s justify-center top-24 relative mx-20 items-stretch">
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_1.jpg" alt="Image 1"/>
                </div>
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_2.jpg" alt="Image 2"/>
                </div>
                <div className="bg-white relative basis-6/12 w-8/12 m-4 flex flex-col justify-between gap-1 text-center ">
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_3.jpg" alt="Image 3"/>
                </div>
                <div className="bg-white relative basis-6/12 w-8/12 m-4 flex flex-col justify-between gap-1 text-center ">
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_4.jpg" alt="Image 4"/>
                </div>
                <div className="bg-white relative basis-6/12 w-8/12 m-4 flex flex-col justify-between gap-1 text-center ">
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_5.jpg" alt="Image 5"/>
                </div>
                <div className="bg-white relative basis-6/12 w-8/12 m-4 flex flex-col justify-between gap-1 text-center ">
            ...
            <div className="top-0  w-1/4 bg-white flex flex-col justify-around items-center m-4 hover:scale-105">
                <div className="bg-white flex justify-center p-4  m-3 basis-2/4">
                    <img className="absoulute h-fit w-fit" src="/images/slika_sobe_6.jpg" alt="Image 6"/>
                </div>
                <div className="bg-white relative basis-6/12 w-8/12 m-4 flex flex-col justify-between gap-1 text-center ">
